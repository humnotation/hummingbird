...
//
MusicXMLParser.measurePrint = function(staffStepper)
{
    this.staffStepper = staffStepper;
};

_.extend(MusicXMLParser.measurePrint.prototype, {
    ...
    init: function ($printNode) {
        ...
        if ( !this.staffStepper ) {
                this.staffStepper = this.staffStepper;
        }
    ...
    adjustDistance: function (distance) {
        var staffHeight = this.scaling.vestStaffHeight;
    ...
    pageStaffTop: function () {
        var ret= this.scaling.vpageHeight - this.topSystemDistance;
    ...
    nextStaffTop: function (currentTop) {
        var ret = currentTop - this.staffDistance - this.scaling.vestStaffHeight;
